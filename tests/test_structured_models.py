...
def test_heading_block_defaults_type_and_accepts_level():
    block = HeadingBlock(
        block_id="block_001", text="Overview", page=1, start_char=0, end_char=8, level=2
    )
...
def test_heading_block_level_is_optional():
    block = HeadingBlock(
        block_id="block_001", text="Overview", page=1, start_char=0, end_char=8
    )
...
def test_paragraph_block_defaults_type():
    block = ParagraphBlock(
        block_id="block_002", text="Some prose.", page=1, start_char=9, end_char=20
    )
...
def test_block_requires_page_at_least_one():
    with pytest.raises(ValidationError):
        HeadingBlock(
            block_id="block_001", text="Overview", page=0, start_char=0, end_char=8
        )
...
def test_page_header_block_defaults_type_and_is_noise():
    block = PageHeaderBlock(
        block_id="block_001", text="Running Title", page=1, start_char=0, end_char=13
    )
...
def test_page_footer_block_defaults_type_and_is_noise():
    block = PageFooterBlock(
        block_id="block_001", text="Page 3", page=1, start_char=0, end_char=6
    )
...
def _sample_document_with_noise() -> StructuredNormalizedDocument:
    ...
    return StructuredNormalizedDocument(
        ...
        blocks=[
            ...
            PageFooterBlock(
                block_id="block_004", text="Page 1", page=1, start_char=35, end_char=41
            ),
        ],
    )
...
def test_document_rejects_duplicate_block_ids():
    with pytest.raises(ValidationError, match="duplicate block_id"):
        StructuredNormalizedDocument(
            ...
            blocks=[
                ParagraphBlock(
                    block_id="block_001", text="A", page=1, start_char=0, end_char=1
                ),
                ParagraphBlock(
                    block_id="block_001", text="B", page=1, start_char=1, end_char=2
                ),
            ],
        )
